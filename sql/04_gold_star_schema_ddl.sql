...
-- ============================================================================
-- 3. DIMENSION: gold.DimCustomer
-- ============================================================================
CREATE TABLE gold.DimCustomer (
 CustomerKey INT IDENTITY(1,1) NOT NULL PRIMARY KEY,
 CustomerName NVARCHAR(200) NOT NULL,
 CustomerType NVARCHAR(50) NOT NULL, -- B2B Wholesale vs B2C Retail
...
CREATE TABLE gold.DimChannel (
 ...
 ChannelType NVARCHAR(50) NOT NULL, -- Marketplace, Wholesale B2B, Direct, Offline
 CreatedDate DATETIME2 NOT NULL DEFAULT SYSUTCDATETIME()
);
GO
...
-- ============================================================================
-- 5. DIMENSION: gold.DimFulfillment
-- ============================================================================
...
-- ============================================================================
-- 7. FACT TABLE: gold.FactSalesOrderItems
-- ============================================================================
...
-- ============================================================================
-- 8. FACT TABLE: gold.FactInventorySnapshot
-- ============================================================================
...
-- ============================================================================
-- 9. FACT TABLE: gold.FactChannelPricing
-- ============================================================================
...
-- ============================================================================
-- 10. FACT TABLE: gold.FactOperationalExpenses
-- ============================================================================
...
PRINT 'Gold Star Schema DDL created successfully with all Dimensions, Facts, Constraints, and Indexes.';
GO
