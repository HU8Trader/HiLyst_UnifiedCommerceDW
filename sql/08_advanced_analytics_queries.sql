...
-- Description: Advanced Analytical Queries (Pareto 80/20, MoM Growth, Cohorts, Arbitrage, Stockout Risk, Marketing ROAS)
-- ============================================================================
...
-- ============================================================================
-- QUERY 3: DIGITAL ADVERTISING ROAS & CAMPAIGN EFFICIENCY (NEW)
...
GROUP BY ch.Platform, c.CampaignName, c.DeviceType, c.TargetLocation
ORDER BY TotalSpend DESC;
GO


-- ============================================================================
-- QUERY 4: INVENTORY STOCKOUT RISK & WORKING CAPITAL BLEED
...
-- ============================================================================
-- QUERY 5: CROSS-CHANNEL PRICING ARBITRAGE SPREADS
